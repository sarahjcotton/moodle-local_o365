...
if (is_siteadmin()) {
    $settings = null;
    $settingscategory = new \local_o365\admin_settingspage_tabs('localsettingo365', get_string('pluginname', 'local_o365'));

    $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_SETUP', 'LOCAL_O365_TAB_SETUP');
    ...
    $page->add(new admin_setting_heading('local_o365_setup_step1', $label, $desc));

    $configdesc = new lang_string('settings_setup_step1clientcreds', 'local_o365', $oidcconfigpageurl->out());
    $page->add(new admin_setting_heading('local_o365_setup_step1clientcreds', '', $configdesc));

    $configdesc = new lang_string('settings_setup_step1_credentials_end', 'local_o365',
        (object)['oidcsettings' => $oidcconfigpageurl->out()]);
    $page->add(new admin_setting_heading('local_o365_setup_step1_credentialsend', '', $configdesc));

    if (auth_oidc_is_setup_complete()) {
        $page->add(new admin_setting_heading('local_o365_existing_settings_heading', '',
            get_string('settings_setup_step1_existing_settings', 'local_o365')));
        // IdP type.
        $page->add(new admin_setting_description('local_o365_existing_settings_idp_type',
            get_string('idptype', 'auth_oidc'), auth_oidc_get_idp_type_name()));
        // Client ID.
        $page->add(new admin_setting_description('local_o365_existing_setting_client_id',
            get_string('clientid', 'auth_oidc'), get_config('auth_oidc', 'clientid')));
        // Authentication type.
        $page->add(new admin_setting_description('local_o365_existing_setting_client_auth_method',
    ...
    if (auth_oidc_is_setup_complete()) {
        ...
        $page->add(new admin_setting_heading('local_o365_setup_step1continue', '', $configdesc));
    }
    ...
    if ($stepsenabled === 2) {
        ...
        if (!empty($systemapiuser)) {
            ...
            $page->add(new admin_setting_heading('local_o365_setup_step2', $label, $desc));
            ...
            $page->add(new admin_setting_configcheckbox('local_o365/enableapponlyaccess', $label, $desc, '1'));
        } else {
            $page->add(new admin_setting_heading('local_o365_setup_step2', $label, $desc));
    ...
    if ($stepsenabled === 4) {
        ...
        $page->add(new admin_setting_heading('local_o365_setup_step4', $label, $desc));

        $label = new lang_string('settings_azuresetup', 'local_o365');
        $desc = new lang_string('settings_azuresetup_details', 'local_o365');
        $page->add(new azuresetup('local_o365/azuresetup', $label, $desc));
    }

    $settingscategory->add($page);

    // LOCAL_O365_TAB_SYNC
    $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_SYNC', 'LOCAL_O365_TAB_SYNC');

    $label = new lang_string('settings_options_usersync', 'local_o365');
    $desc = new lang_string('settings_options_usersync_desc', 'local_o365');
    $page->add(new admin_setting_heading('local_o365_options_usersync', $label, $desc));
    ...
    $default = [];
    $page->add(new usersynccreationrestriction($key, $label, $desc, $default));
    ...
    $page->add(new auth_oidc_admin_setting_label('local_o365/fieldmap', $label, $desc, null));
    ...
    $page->add(new admin_setting_configtime('local_o365/usersync_suspension_h', 'usersync_suspension_m',
        $label, $desc, ['h' => 2, 'm' => 30]));
    ...
    $page->add(new admin_setting_configcheckbox('local_o365/support_upn_change', $label, $desc, '0'));
    ...
    $page->add(new admin_setting_heading('local_o365_section_coursesync', $label, $desc));

    // Course sync setting.
    $label = new lang_string('settings_coursesync', 'local_o365');
    $desc = new lang_string('settings_coursesync_details', 'local_o365');
    $page->add(new coursesync('local_o365/coursesync', $label, $desc, 'off'));
    ...
    $page->add(new admin_setting_configcheckbox('local_o365/delete_group_on_course_deletion', $label, $desc, '0'));
    ...
    $page->add(new admin_setting_configcheckbox('local_o365/delete_group_on_course_sync_disabled', $label, $desc, '0'));
    ...
    $page->add(new admin_setting_configtext('local_o365/courses_per_task', $label, $desc, 20, PARAM_INT));

    // Team / group name section.
    $page->add(new admin_setting_heading('local_o365_section_team_name',
    ...
    $page->add(new admin_setting_configtext('local_o365/team_name_prefix',
    ...
    $page->add(new admin_setting_configselect('local_o365/team_name_course',
    ...
    $page->add(new admin_setting_configtext('local_o365/team_name_suffix',
    ...
    $page->add(new admin_setting_configtext_with_maxlength('local_o365/group_mail_alias_prefix',
    ...
    $page->add(new admin_setting_configselect('local_o365/group_mail_alias_course',
    ...
    $page->add(new admin_setting_configtext_with_maxlength('local_o365/group_mail_alias_suffix',
    ...
    $page->add(new admin_setting_heading('local_o365_section_team_name_sample', '',
        get_string('settings_team_name_sample', 'local_o365',
            ['teamname' => $sampleteamname, 'mailalias' => $samplegroupalias])));

    // Sync Team name.
    $page->add(new admin_setting_configcheckbox('local_o365/team_name_sync',
    ...
    // LOCAL_O365_TAB_ADVANCED
    $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_ADVANCED', 'LOCAL_O365_TAB_ADVANCED');

    // Tools.
    $label = new lang_string('settings_header_tools', 'local_o365');
    $desc = '';
    $page->add(new admin_setting_heading('local_o365_section_tools', $label, $desc));
    ...
    $page->add(new toollink('local_o365/tenants', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new toollink('local_o365/healthcheck', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new toollink('local_o365/userconnections', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new toollink('local_o365/teamconnections', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new toollink('local_o365/usermatch', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new toollink('local_o365/maintenance', $label, $linktext, $linkurl, $desc));
    ...
    $page->add(new admin_setting_heading('local_o365_section_advanced', $label, $desc));
    ...
    $desc = new lang_string('settings_course_reset_teams_details', 'local_o365');
        $page->add(new courseresetteams('local_o365/course_reset_teams', $label, $desc,
        COURSE_SYNC_RESET_SITE_SETTING_DO_NOTHING));
>>>>>>> Use admin_settingspage_tabs so settings appear in admin tree
    }
    ...
    $page->add(new admin_setting_configtext('local_o365/reset_team_name_prefix', $label, $desc, '(archived) ', PARAM_TEXT));
    ...
    $page->add(new admin_setting_configtext('local_o365/reset_group_name_prefix', $label, $desc, 'disconnected-',
    PARAM_TEXT));

    $label = new lang_string('settings_o365china', 'local_o365');
    $desc = new lang_string('settings_o365china_details', 'local_o365');
    $page->add(new admin_setting_configcheckbox('local_o365/chineseapi', $label, $desc, '0'));
    ...
    $page->add(new admin_setting_configcheckbox('local_o365/debugmode', $label, $desc, '0'));
    ...
    $page->add(new admin_setting_configtext('local_o365/switchauthminupnsplit0', $label, $desc, '10'));

    $label = new lang_string('settings_photoexpire', 'local_o365');
    $desc = new lang_string('settings_photoexpire_details', 'local_o365');
    $page->add(new admin_setting_configtext('local_o365/photoexpire', $label, $desc, '24'));
    ...
    $page->add(new admin_setting_configselect('local_o365/customtheme', $label, $desc, 'boost_o365teams', $options));

    $settingscategory->add($page);

    // LOCAL_O365_TAB_SDS
    $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_SDS', 'LOCAL_O365_TAB_SDS');
    ...
    $page->add(new admin_setting_heading('local_o365_sds_intro', '', $desc));
    ...
    if ($apiclient) {
        try {
            ...
            if (!empty($schools)) {
                ...
                $page->add(new admin_setting_heading('local_o365_sds_coursecreation', $label, $desc));
                ...
                $page->add(new admin_setting_configmulticheckbox('local_o365/sdsschools', $label, $desc, 'oncustomc',
                    $coursesynchoices));
                ...
                $page->add(new admin_setting_configcheckbox('local_o365/sdsteamsenabled', $label, $desc, '0'));
                ...
                $page->add(new admin_setting_configcheckbox('local_o365/sdsenrolmentenabled', $label, $desc, '0'));
                ...
                $page->add(new admin_setting_configcheckbox('local_o365/sdssyncenrolmenttosds', $label, $desc, '0'));
                ...
                $page->add(new admin_setting_configselect('local_o365/sdsenrolmentteacherrole', $label, $desc, 3,
                    $roleoptions));
                ...
                $page->add(new admin_setting_configselect('local_o365/sdsenrolmentstudentrole', $label, $desc, 5,
                    $roleoptions));
                ...
                $page->add(new admin_setting_configselect('local_o365/sdsschooldisabledaction', $label, $desc,
                ...
                $page->add(new admin_setting_heading('local_o365_sds_profilesync_header', $label, $desc));
                ...
                $page->add(new admin_setting_configselect('local_o365/sdsprofilesync', $label, $desc, '0',
                    $profilesyncchoices));
            } else {
                // SDS no school notification.
                $desc = new lang_string('settings_sds_noschools', 'local_o365');
                $page->add(new admin_setting_heading('local_o365_sds_noschools', '', $desc));
            }
        } catch (Exception $e) {
            $desc = new lang_string('settings_sds_get_schools_error', 'local_o365');
            $page->add(new admin_setting_heading('local_o365_sds_get_schools_error', '', $desc));
        }
    }

    $settingscategory->add($page);

    // LOCAL_O365_TAB_TEAMS
    $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_TEAMS', 'LOCAL_O365_TAB_TEAMS');
    ...
    $page->add(new admin_setting_heading('local_o365/teams_setting_banner', '', $bannerhtml));

    // Moodle set up header.
    $page->add(new admin_setting_heading('local_o365/teams_setting_moodle_setup_heading', '',
    ...
    $page->add(new moodlesetup('local_o365/moodlesetup', $label, $desc));

    // Instructions.
    $page->add(new admin_setting_heading('local_o365/teams_setting_instructions', '',
        get_string('settings_teams_additional_instructions', 'local_o365')));

    // Setting bot_app_id.
    $page->add(new admin_setting_configtext_with_maxlength('local_o365/bot_app_id',
    ...
    $page->add(new admin_setting_configpasswordunmask('local_o365/bot_app_password',
    ...
    $page->add(new admin_setting_heading('local_o365/teams_json_download', '', $jsondownloadhtml));
    ...
    $page->add(new admin_setting_heading('local_o365/teams_deploy_bot', '', $deploybuttonhtml));

    // Setting teams_moodle_app_external_id.
    $page->add(new admin_setting_configtext('local_o365/teams_moodle_app_external_id',
    ...
    $page->add(new admin_setting_configtext('local_o365/teams_moodle_app_short_name',
    ...
    $page->add(new admin_setting_configcheckbox('local_o365/bot_feature_enabled',
        get_string('settings_bot_feature_enabled', 'local_o365'),
        $botfeatureenableddescription,
        '0'));

    // Setting bot_webhook_endpoint.
    $page->add(new admin_setting_configtext('local_o365/bot_webhook_endpoint',
    ...
    $page->add(new admin_setting_heading('download_manifest_header', '', $downloadmanifesthtml));

    $settingscategory->add($page);

    // LOCAL_O365_TAB_MOODLE_APP
    if (local_o365_show_teams_moodle_app_id_tab()) {
        $page = new admin_settingpage('local_o365/LOCAL_O365_TAB_MOODLE_APP', 'LOCAL_O365_TAB_MOODLE_APP');
        ...
        $page->add(new admin_setting_configtext('local_o365/moodle_app_id',
        ...
        if (\local_o365\utils::is_connected() === true) {
            ...
            $page->add(new admin_setting_heading('set_moodle_app_id_instruction_header', '', $setmoodleappidinstructionhtml));
        }
